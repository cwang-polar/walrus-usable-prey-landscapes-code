...
| Figure 3. Sliding-interval prey biomass summaries | `scripts/06_make_figures_and_tables.py::plot_figure_3_sliding_interval_biomass` | Source summaries are produced in `scripts/01_prepare_benthic_surfaces.py`; uncertainty used 200 station-observation bootstrap resamples per interval with random seed 123. |
